...
The git repository shows the use of the Youtube API v3, LitElement with TypeScript, and [Material Web Components](https://github.com/material-components/material-web).
...
npm i
```
Create config.json on the root and add YoutubeAPI key
```
{
